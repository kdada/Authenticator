...
export const MigrationPayload = $root.MigrationPayload = (() => {
    ...
    MigrationPayload.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MigrationPayload();
    ...
    MigrationPayload.verify = function verify(message) {
        ...
        if (message.otpParameters != null && message.hasOwnProperty("otpParameters")) {
            ...
            for (let i = 0; i < message.otpParameters.length; ++i) {
                let error = $root.MigrationPayload.OtpParameters.verify(message.otpParameters[i]);
                if (error)
    ...
    MigrationPayload.fromObject = function fromObject(object) {
        if (object instanceof $root.MigrationPayload)
            return object;
        let message = new $root.MigrationPayload();
    ...
    MigrationPayload.OtpParameters = (function() {
        ...
        OtpParameters.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.MigrationPayload.OtpParameters();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        OtpParameters.fromObject = function fromObject(object) {
            if (object instanceof $root.MigrationPayload.OtpParameters)
                return object;
            let message = new $root.MigrationPayload.OtpParameters();
